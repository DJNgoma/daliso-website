...
function renderFooter() {
  ...
  <footer>
    <div class="container">
      ...
      <p class="footer-copy">© 2026 Daliso Ngoma. <a href="/privacy/">Privacy Policy</a> · <a href="https://github.com/DJNgoma/daliso-website" target="_blank" rel="noopener noreferrer">Source Code</a></p>
    </div>
  </footer>
  `;
}
